        ...
        >
          ...
          <template #item-actions="item">
            <div class="flex items-center gap-1">
              ...
              <!-- Delete button -->
              <VDropdown>
                <button class="btn-icon p-1.5" v-tooltip="'Delete'" type="button">
                ...
                <template #popper="{ hide }">
                  <div class="p-5">
                    ...
                    <div class="mt-3 flex items-center gap-2">
                      <button
                        @click="deleteContact(item.id, hide)"
...
<script setup lang="ts">
  ...
  const deleteContact = async (id: string, hide: () => void) => {
